...
# ACDS 18.0 614 win32 2018.11.10.18:07:20
# ----------------------------------------
...
# ----------------------------------------
# If div_s is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/div_s_memoryC0_uid146_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/div_s_memoryC0_uid147_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/div_s_memoryC1_uid150_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/div_s_memoryC1_uid151_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/div_s_memoryC2_uid154_invTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/div_s.vo"
}
